import './TermsOfUseSplash.css'

const TermsOfUseSplash = () => {

  return (

    <div>
      <div className='terms-of-use-splash-text-container'>
        <span className='tou-subheading' id='tou-splash-subheading'>Non-Commercial Use Only</span>
        ...
        <span className='tou-subheading' id='tou-splash-subheading'>Copyright and Intellectual Property</span>
        ...
        <span className='tou-subheading' id='tou-splash-subheading'>User Responsibility</span>
        ...
        <span className='tou-subheading' id='tou-splash-subheading'>No Endorsement or Affiliation</span>
        ...
        <span className='tou-subheading' id='tou-splash-subheading'>Community Guidelines and Content Generation</span>
...
export default TermsOfUseSplash